...
CASE
WHEN
CREATION_DPT_CODE IN ('9295') THEN '9261'
...
NULL AS TO_CIP_FLAG,
NULL AS PUSH_FLAG,
'EW2021122000014' AS REQ_NO
FROM CIFX.TB_CUSTOMER
WHERE CREATION_DPT_CODE IN('9295')
...
CASE
WHEN PERFORMANCE_DPT_CODE IN ('9295') THEN '9261'
END AS COLUMN_CHANGE_VALUE,
NULL AS CHECK_CHANGE_LOG,
NULL AS CHECK_SPECIFIC_RULES,
...
'EW2021122000014' AS REQ_NO
FROM CIFX.TB_CUSTOMER
WHERE PERFORMANCE_DPT_CODE IN('9295');
--=====  9295 to 9261 end ===========
